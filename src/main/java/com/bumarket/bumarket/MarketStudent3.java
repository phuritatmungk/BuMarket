 ...
 * @author USER
 */
public class MarketStudent3 extends javax.swing.JFrame {

    /**
     * Creates new form MarketStudent3
     */
    public MarketStudent3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtProduct.setText("เสื้อเชิ้ตสีขาวเครื่องแบบ ชุดยูนิฟอร์ม");
        ...
        txt2.setText("ส่งจากเชียงใหม่ 2-3 วัน");
        ...
        txt3.setText("สำหรับขนาด โปรดดูภาพหน้าจอคำแนะนำขนาดหรือปรึกษาฝ่ายบริการลูกค้า");
        ...
        txt6.setText("#แถมเน็กไท");
        jPanel3.add(txt6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 460, 20));

        txt7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txt7.setText("ขนาด  : M , L , XL , 2XL");
        ...
        txt8.setText("#เสื้อนักศึกษา ");
        jPanel3.add(txt8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 460, 20));
        ...
        Productshirt1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Student uniform3.1.jpg"))); // NOI18N
        ...
        Productshirt3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Student uniform3.2.jpg"))); // NOI18N
        jPanel1.add(Productshirt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 360, 90, -1));

        Productshirt4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Student uniform3.4.jpg"))); // NOI18N
        jPanel1.add(Productshirt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, 90, -1));

        Productshirt5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Student uniform3.3.jpg"))); // NOI18N
        jPanel1.add(Productshirt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 360, 90, -1));
        ...
        jPanel1.add(btnSizeXL1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 400, 50, 30));
    ...
    private void btnBuyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuyMouseClicked
        ...
        user.setProduct("เสื้อเชิ้ตสีขาวเครื่องแบบ ชุดยูนิฟอร์ม ");
        user.setQty(1);
        user.setPrice(119.00);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarketStudent3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
